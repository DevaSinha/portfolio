...
export function ProjectCarousel({ children, options }: ProjectCarouselProps) {
                ...
                <div className="flex touch-pan-y touch-pinch-zoom">
                    {React.Children.map(children, (child, index) => {
                        ...
                        return (
                            <motion.div
                                key={index}
                                className="min-w-0 flex-[0_0_85%] md:flex-[0_0_70%] lg:flex-[0_0_55%] px-2 cursor-pointer"
                            ...
                            >
                                <motion.div
                                    ...
                                    className={`h-full ${!isActive ? 'blur-[4px]' : ''}`}
                                    style={{
